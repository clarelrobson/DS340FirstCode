...
# Uni 1
bmr_uni_4 = mlr::benchmark(learners = lrns, tasks = tsks, resamplings = outer_simple, measures = msrs, show.info = TRUE)

parallelStop()


## --------------------------------------------------------------------------------------------------------------------------
save(bmr_uni_4, file = "../../Results/benchmark_uni_4.RData")
...
# RF
model_rf_inst_uni_4 = train(learner_RF, task_inst)
model_rf_e_uni_4 = train(learner_RF, task_e)
model_rf_all_uni_4 = train(learner_RF, task_all)

# GLM
model_glm_inst_uni_4 = train(learner_GLM, task_inst)
model_glm_e_uni_4 = train(learner_GLM, task_e)
model_glm_all_uni_4 = train(learner_GLM, task_all)

parallelStop()


## --------------------------------------------------------------------------------------------------------------------------
save(model_rf_inst_uni_4, model_rf_e_uni_4, model_rf_all_uni_4,
     model_glm_inst_uni_4, model_glm_e_uni_4, model_glm_all_uni_4, 
     file = "../../Results/models_trained_uni_4.RData")
